...
CREATE TABLE TipoLogradouro (
    idTipoLogradouro INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE DDD (
    idDDD INT AUTO_INCREMENT PRIMARY KEY,
    DDD VARCHAR(45)
);
...
CREATE TABLE Consulta (
    NroConsulta INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Exame (
    NroExame INT AUTO_INCREMENT PRIMARY KEY,
